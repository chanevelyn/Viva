...
:::image type="content" source="../../media/glint/setup/360-add-subject-in-manage-subjects.png"alt-text="Screenshot of the Add a Subject section.":::
...
> [!NOTE]
> Employees, other than the Subject, can be added to any feedback provider category. These employees can’t be added to multiple Feedback Provider categories for a single Subject.
