...
4. From the **Actions dropdown** menu, select **Reopen Survey**.
   A **Reopen Survey Cycle** window opens.
...
5. To reopen this survey cycle, select a new close date. To avoid duplicating work for managers, reopen the cycle within one day of the previous cycle end date. Consider this guidance, then review and adjust as needed:
