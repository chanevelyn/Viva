...
For more information about how AI works in Viva Engage, see [Data, Privacy, and Security for Microsoft 365 Copilot in Viva Engage](https://learn.microsoft.com/en-us/viva/engage/manage-security-and-compliance/data-privacy-security-copilot-engage)

For a more detailed walkthrough of Advanced moderation and its use of themes, see the [Communications dashboard: Advanced moderation](https://support.microsoft.com/en-us/topic/13f58cf0-b8e5-40ab-bc55-34d69f762c1d?preview=true) article.
