...
Theme moderation is built upon the [Viva Engage **AI Summarization** service](/viva/engage/engage-ai-summarization). This feature gives Viva Engage users and admins access to Large Language Model (LLM) technology with [Microsoft Responsible AI protections](https://www.microsoft.com/ai/responsible-ai).
